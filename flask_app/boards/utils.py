...
from flask_app.gaze_manager.models import GazeData
...
tag_images = [cv2.imread("flask_app/static/tags/aruco0.png"), cv2.imread("flask_app/static/tags/aruco1.png"),
              cv2.imread("flask_app/static/tags/aruco2.png"), cv2.imread("flask_app/static/tags/aruco3.png")]
tag_rel_size = 0.25
...
pointer_imgs = [cv2.imread("flask_app/static/crosshairWhite.png", cv2.IMREAD_UNCHANGED),
                cv2.imread("flask_app/static/circleWireWhite.png", cv2.IMREAD_UNCHANGED),
                cv2.imread("flask_app/static/circleFullWhite.png", cv2.IMREAD_UNCHANGED),
                cv2.imread("flask_app/static/circleGradientWhite.png", cv2.IMREAD_UNCHANGED)]
