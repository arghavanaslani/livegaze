...
from flask_app.extensions.db_config import redis_client, db
from flask_app.extensions import redis_constants
from flask_app.trackers.models import Tracker, TrackerState
from flask_app.trackers.utils import updated_tracker_state
import json
